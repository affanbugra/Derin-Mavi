...
Kamera bu dosyada DEGIL: app/kamera.py (yalniz takili harici USB-C kamera; test icin
DERINMAVI_CAM=dosya.mp4 / rtsp://...). Burasi gelen kareyi isler.
"""
import os
import time
import tempfile
...
# Kamera ALGI'NIN isi DEGIL: kaynak app/kamera.py'de (yalniz harici USB-C kamera;
# dahili/telefon/sanal kameralar hic acilmaz). Burasi yalniz gelen kareyi isler.
